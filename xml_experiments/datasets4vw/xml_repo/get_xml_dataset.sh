...
if [ -e "./$FILES_PREFIX/${FILES_PREFIX}_train.txt" ]; then
    ...
    cp  "./$FILES_PREFIX/${FILES_PREFIX}_train.txt"  "./$FILES_PREFIX/${FILES_PREFIX}_train"
    mv  "./$FILES_PREFIX/${FILES_PREFIX}_train.txt"  "./$FILES_PREFIX/train.txt"
    xml_dataset4vw "./$FILES_PREFIX/${FILES_PREFIX}_train"

    cp  "./$FILES_PREFIX/${FILES_PREFIX}_test.txt"  "./$FILES_PREFIX/${FILES_PREFIX}_test"
    mv  "./$FILES_PREFIX/${FILES_PREFIX}_test.txt"  "./$FILES_PREFIX/test.txt"
